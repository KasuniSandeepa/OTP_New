...
//        DateTimeFormatter CurrentTime = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm");
...
//        int time = Integer.parseInt(SubstractedTime.substring(11, 13)) + Integer.parseInt(SubstractedTime.substring(14, 16));
        ...
        try {
            ...
            if (RsUser.next()) {
                ...
                if (OTPNumber.equals(RsUser.getString("OTP"))) {
